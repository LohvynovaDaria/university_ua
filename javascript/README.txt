...
Завдання №5
Опис задачі
Створити змінну «resultArray» (масив). Створити змінні «first» = 1, «second» = 2, «senseOfLife» = 42. За допомогою методу масива .push() додати в масив спочатку «first» потім «second». 
